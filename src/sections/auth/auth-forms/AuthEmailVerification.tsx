...
const AuthEmailVerification = (props: any) => {
  const theme = useTheme();
  const navigate = useNavigate();
  const email = props.email;
  const handleResendClick = async () => {
    try {
      const response = await axios.post('/api/v1/user/verify-email-resend', { email });
      if (response.status === 200) {
        dispatch(
          openSnackbar({
            open: true,
            message: 'Send verification email. Please check your mail box. Do not forget to check spam.',
            variant: 'alert',
            alert: {
              color: 'success'
            },
        ...
        dispatch(
          openSnackbar({
            open: true,
            message: 'Please resend email verification',
            variant: 'alert',
            alert: {
              color: 'warning'
            },
  ...
  return (
    <Grid container spacing={3} sx={{ paddingTop: '10vh' }}>
      <Grid item xs={12} display={'flex'} justifyContent={'center'}>
        <Stack spacing={3} display={'flex'} justifyContent={'center'} alignItems={'center'} height={'20vh'}>
          <svg fill="none" xmlns="http://www.w3.org/2000/svg" width={'200'} height={'200'} aria-hidden="true" role="img">
            <g clip-path="url(#clip0_11448_56766)">
              <path
                ...
                fill="url(#paint0_linear_11448_56766)"
              ></path>
              ...
              <path
                ...
                fill="url(#paint1_linear_11448_56766)"
              ></path>
              <path
                ...
                fill="url(#paint2_linear_11448_56766)"
              ></path>
              <path
              ...
              <path
                ...
                fill="url(#paint3_linear_11448_56766)"
              ></path>
              <path
                ...
                fill="url(#paint4_linear_11448_56766)"
              ></path>
              <path
                ...
                fill="url(#paint5_linear_11448_56766)"
              ></path>
              <path
      ...
      <Grid item xs={12} sx={{ textAlign: 'center' }}>
        We just sent an email to the address: {props.email}
      </Grid>
      <Grid item xs={12} sx={{ textAlign: 'center' }}>
      ...
      <Grid item xs={12} lg={6} md={12} sm={12}>
        <AnimateButton>
          <Button
            ...
            type="submit"
            variant="contained"
            style={{ color: 'white', backgroundColor: theme.palette.primary.darker, whiteSpace: 'nowrap' }}
